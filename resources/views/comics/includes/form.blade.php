...
<div class="mb-3">
    ...
    {{-- @error('series')
        <div class="alert alert-danger mt-1 w-50 style_error_message">{{ $message }}</div>
    @enderror --}}
    @include('comics.includes.messageError', ['name' => 'series'])
</div>
...
<div class="mb-3">
    ...
    {{-- @error('type')
        <div class="alert alert-danger mt-1 w-50 style_error_message">{{ $message }}</div>
    @enderror --}}
    @include('comics.includes.messageError', ['name' => 'type'])
</div>
...
<div class="mb-3">
    ...
    {{-- @error('price')
        <div class="alert alert-danger mt-1 w-50 style_error_message">{{ $message }}</div>
    @enderror --}}
    @include('comics.includes.messageError', ['name' => 'price'])
</div>
...
<div class="mb-3">
    ...
    {{-- @error('sale_date')
        <div class="alert alert-danger mt-1 w-50 style_error_message">{{ $message }}</div>
    @enderror --}}
    @include('comics.includes.messageError', ['name' => 'sale_date'])
</div>
